...
public abstract class AbstractDragController implements DragController
{
	...
	/**
	 * Whether scrollIntoView() or it's equivalent is to be called during
	 * dragging.
	 */
	 ...
	 * 
	 * @param boundaryPanel
	 *            the desired boundary panel or <code>RootPanel.get()</code> if
	...
	/**
	 * Attaches a {@link MouseDragHandler} to the widget, applies styles to the
	 * draggable and the handle.
	 * 
	...
	/**
	 * Similar to {@link #makeDraggable(Widget)}, but allow separate, child to
	 * be specified as the drag handle by which the first widget can be dragged.
	 * 
	 * @param draggable
	 *            the widget to be made draggable
	 * @param dragHandle
	 ...
	 * {@link MouseDragHandler} from the widget and removing any styling which
	 * was applied when making the widget draggable.
	 * 
	 * @param draggable
	 *            the widget to no longer be draggable
	 */
	@Override
