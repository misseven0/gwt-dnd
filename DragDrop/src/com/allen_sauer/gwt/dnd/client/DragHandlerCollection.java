...
public class DragHandlerCollection extends ArrayList<DragHandler>
{
	...
	/**
	 * Fires a {@link DragHandler#onDragEnd(DragEndEvent)} on all handlers in
	 * the collection.
	 * 
	 * @param dragEndEvent
	 *            the event
	...
	/**
	 * Fires a {@link DragHandler#onDragStart(DragStartEvent)} on all handlers
	 * in the collection.
	 * 
	...
	/**
	 * Fires a {@link DragHandler#onPreviewDragEnd(DragEndEvent)} on all
