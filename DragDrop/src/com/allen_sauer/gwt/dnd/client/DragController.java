...
public interface DragController extends FiresDragEvents
{
	 ...
	 * operation.
	 * 
	 * @return number of pixels or <code>0</code> (zero) if mouse down starts
	 *         the drag
	 */
	 ...
	 * 
	 * @return <code>true</code> if multiple widget selection behavior is
	 *         enabled
	 */
	boolean getBehaviorMultipleSelection();

	/**
	 * Determines whether containing panels and the browser window should be
	 * scrolled during dragging in order to keep draggable widgets visible.
	 * 
	 * @return <code>true</code> if containing panels and the browser window are
	 *         to be scrolled during dragging to keep draggable widgets visible
	 */
	...
	/**
	 * Enable dragging on widget. Call this method for each widget that you
	 * would like to make draggable under this drag controller.
	 * 
	 * @param draggable
	 ...
	 *            the widget to be made draggable
	 * @param dragHandle
	 *            the widget by which widget can be dragged
	 */
	 ...
	 * 
	 * @param widget
	 *            the widget which should no longer be draggable
	 */
	...
	/**
	 * Reset the internal drop controller (drop target) cache which is
	 * initialized primarily by {@link AbstractDragController#dragStart()}. This
	 * method should be called when a drop target's size and/or location
	 * changes, or when drop target eligibility changes.
	 */
	void resetCache();
	 ...
	 * 
	 * @param cancelDocumentSelections
	 *            <code>true</code> if dragging should cancel document
	 *            selections
	 */
	 ...
	 * drag proxy.
	 * 
	 * @param constrainedToBoundaryPanel
	 *            whether or not to constrain to the boundary panel
	 */
	 ...
	 * 
	 * @param pixels
	 *            number of pixels or <code>0</code> (zero) to start dragging on
	 *            mouse down
	 */
	void setBehaviorDragStartSensitivity(int pixels);

	/**
	 * Sets whether multiple widgets can be selected for dragging at one time
	 * via <code>CTRL</code>/ <code>META</code>-click. Defaults to
	 * <code>true</code>.
	 * 
	 * @param multipleSelectionAllowed
	 *            whether multiple selections are enabled
	 */
	void setBehaviorMultipleSelection(boolean multipleSelectionAllowed);

	/**
	 * Set whether or not to scroll containing panels and the browser window
	 * during drag operations in order to keep the draggable widgets visible.
	 * The default is <code>true</code>.
	 * 
	 * @param scrollIntoView
	 *            whether or not to scroll panels and browser window to keep
	 *            draggable widgets visible
	 */
