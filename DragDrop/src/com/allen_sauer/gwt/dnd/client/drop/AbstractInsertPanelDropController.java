...
public abstract class AbstractInsertPanelDropController extends AbstractPositioningDropController
{
	...
	/**
	 * Called by {@link AbstractInsertPanelDropController#onEnter(DragContext)}
	 * to create a new positioner widget for this {@link InsertPanel} drop
	 * target. Override this method to customize the look and feel of your
	 * positioner. The positioner widget may not have any CSS borders or
	 * margins, although there are no such restrictions on the children of the
	 * positioner widget. If borders and/or margins are desired, wrap that
	 * widget in a {@link com.google.gwt.user.client.ui.SimplePanel} with a
