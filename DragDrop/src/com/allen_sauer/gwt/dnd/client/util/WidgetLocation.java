...
public class WidgetLocation extends AbstractLocation
{
	 ...
	 * <code>reference</code> need not be the parent node, or even an ancestor
	 * of <code>widget</code>. Therefore coordinates returned may be negative or
	 * may exceed the dimensions of <code>reference</code>.
	 * 
	 * @param widget
	 *            the widget whose coordinates we seek
	 * @param reference
	 *            the widget relative to which we seek our coordinates
	 */
