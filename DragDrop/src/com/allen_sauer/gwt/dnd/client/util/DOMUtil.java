...
public class DOMUtil
{
	 ...
	 * TODO Change IndexedPanel -> InsertPanel
	 */
	static void debugWidgetWithColor(IndexedPanel parent, int index, String color)
	{
		if (DEBUG)
		{
	...
	public native static NativeEvent createTouchEndEvent(boolean bubbles, boolean cancelable, int detail, boolean ctrlKey,
			boolean altKey, boolean shiftKey, boolean metaKey, JsArray<Touch> changedTouches) /*-{
