...
public interface Area
{
	...
	/**
	 * Determine the shortest distance from the location to the edge of the
	 * area. Zero indicates a location on the edge. Negative distances indicate
	 * a location inside the area.
	 * 
	 * @param location
