...
public class PickupDragController extends AbstractDragController
{
	 ...
	 *            (read https://github.com/fredsa/gwt-dnd/wiki/GettingStarted)
	 ...
	 * provide their own drag proxies. Widgets that implement
	 * {@link HasDragProxy} are evaluated here as well.
	 *
	 * @param context
...
//						info.initialDraggableParentLocation.getTop());
			...
			} else
			{
				throw new RuntimeException(
						"Unable to handle initialDraggableParent " + info.initialDraggableParent.getClass().getName());
			}
		}
	}
